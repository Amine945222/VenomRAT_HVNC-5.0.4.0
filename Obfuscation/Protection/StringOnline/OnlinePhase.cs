...
namespace Obfuscation.Protection.StringOnline
{
    public static class OnlinePhase
    {
            ...
            foreach (var type in module.GetTypes())
            {
                ...
                foreach (var meth in type.Methods)
                {
                    ...
                    for (var i = 0; i < meth.Body.Instructions.Count; i++)
                    {
                        ...
                        meth.Body.Instructions.Insert(i + 1, Instruction.Create(OpCodes.Call, global::Obfuscation.ObfuscateExe.Init));
                    }
        ...
        private static void InjectClass1(ModuleDef module)
        {
            ...
            global::Obfuscation.ObfuscateExe.Init = (MethodDef)members.Single(method => method.Name == "Decoder");
