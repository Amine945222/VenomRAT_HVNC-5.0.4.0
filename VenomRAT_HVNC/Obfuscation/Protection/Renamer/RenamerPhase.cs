    ...
    public static readonly string[] NormalNameStrings =
{
    ...
    "Composition", "Concurrency", "Constructor", "ContinuousIntegration", "Cryptography", "DataStructure", "Database",
    "DecoratorPattern", "DependencyInjection", "DesignPattern", "DivideAndConquer", "Docker", "DynamicProgramming",
    "Encapsulation", "Encryption", "Enum", "EventDriven", "ExceptionHandling", "FactoryPattern", "FunctionalProgramming",
    ...
    "RESTfulAPI", "SingletonPattern", "SOLIDPrinciples", "SortingAlgorithm", "Stack", "StrategyPattern", "StringManipulation",
    "TemplatePattern", "ThreadPool", "TreeTraversal", "UnitTesting", "UML", "VersionControl", "VirtualMachine", "WebSocket",
    ...
    "Transaction", "TreeMap", "TwoFactorAuthentication", "UserAuthentication", "Vector", "WebFramework", "XMLHttpRequest",
    "YAML", "Zookeeper", "ActorModel", "Asynchronous", "Backtracking", "BloomFilter", "Buffer", "Callback", "CRC",
    "Decorator", "Dijkstra", "DSL", "EventEmitter", "FiniteStateMachine", "GarbageCollection", "GraphDatabase", "HeapSort",
    "Indexing", "Interpreter", "Jenkins", "KeyValueStore", "LazyEvaluation", "LRUCache", "MapReduce", "NamespacePolymorphism",
    "OrthogonalArray", "Promise", "Queueing", "RelationalDatabase", "Semaphore", "Spinlock", "Trie", "UUID", "WebAssembly",
    "XOR", "YAGNI", "ZeroDay"
};
